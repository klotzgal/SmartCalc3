...
"")
    ...
    def retranslateUi(self, Graphic):
        ...
        self.autoscale.setText(QCoreApplication.translate("Graphic", u"Autoscale", None))
        self.label_x_max.setText(QCoreApplication.translate("Graphic", u"Range", None))
